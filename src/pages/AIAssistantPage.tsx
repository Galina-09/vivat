...
const suggestedQuestions = [
  ...
  'Порівняйте ціни на будинки на Замості',
    ...
    setTimeout(() => {
      const aiResponses: Record<string, Message> = {
        apartment: {
          ...
          recommendations: [
            {
              title: '3-кімнатна квартира на 600-річчя',
              price: 95000,
              address: 'вул. 600-річчя, 22',
              type: 'apartment',
            },
            {
              title: 'Просторий пентхаус на Агрономічному',
              price: 85000,
              address: 'с. Агорономічне, п-т Сонячний, 15',
              type: 'apartment',
            },
            {
              title: 'Елітна квартира у Премєр-Тауер',
              price: 99000,
              address: 'вул. Космонавтів, 3',
              type: 'apartment',
            },
          ],
        },
